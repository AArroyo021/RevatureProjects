...
def create_customer_entry():
    try:
        ...
        customer_to_return = customer_postgres_imp.create_customer(new_customer)
...
def get_customer_info(customer_id):
    try:
        customer_information = customer_postgres_imp.get_customer_info(int(customer_id))
...
def update_customer_info(customer_id: str):
    try:
        ...
        updated_customer = customer_postgres_imp.update_customer_info(new_customer)
...
def delete_customer_info(customer_id: str):
    result = customer_postgres_imp.delete_customer_info(int(customer_id))
    if result:
